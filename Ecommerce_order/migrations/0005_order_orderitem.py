# Generated by Django 4.0.6 on 2022-07-28 18:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Ecommerce_order', '0004_alter_cart_owner_session'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Ecommerce_order.order')),
            ],
            options={
                'db_table': 'OrderItem',
            },
