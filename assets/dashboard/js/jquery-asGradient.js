...
(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    define('AsGradient', ['exports', 'jquery', 'static_cdn/static_root/dashboard/js/jquery-asColor'], factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('jquery'), require('static_cdn/static_root/dashboard/js/jquery-asColor'));
  } else {
    var mod = {
      exports: {}
    };
